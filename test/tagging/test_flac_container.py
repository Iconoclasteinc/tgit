...
def test_reads_recording_studio_address_from_recording_studio_address_field(flac):
    metadata = container.load(flac(RECORDING_STUDIO_ADDRESS="2020 des zinzins, Montreal"))
...
def test_reads_tags_from_tags_field(flac):
    metadata = container.load(flac(TAG=["tag1", "tag2", "tag3"]))
