...
<context>
    <name>project_edition_page</name>
    <message>
...
<context>
    ...
    <message>
        <location filename="tgit/ui/track_edition_page.py"/>
        <source>Information about the recording studio:</source>
        <translation>Informations sur le studio d&apos;enregistrement :</translation>
    </message>
    <message>
        <location filename="tgit/ui/track_edition_page.py"/>
        <source>Recording Studio</source>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Le &lt;span style="font-style:italic;"&gt;Interested Parties Information Code&lt;/span&gt; est utilisé pour identifier les créateurs et les éditeurs.&lt;/p&gt;&lt;p&gt;Il est recommandé de visiter votre profil sur le site de votre collectif (SOCAN, SACEM, SODRAC, etc.) pour récupérer votre IPI. Vous pouvez aussi le rechercher dans la base http://iswcnet.cisac.org/ en entrant le titre de l&apos;une de vos oeuvres déclarées par le passé.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="tgit/ui/track_edition_page.py" />
        <source>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;This field is important to distinguish between different versions of similar tracks. It is used to mention a live version, a shortened version for radio, a remix, etc... Free text as you wish it to appear in a music player.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</source>
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Ce champ est important pour distinguer les pistes concernant la même œuvre et dont la seule différence est la version originale, en concert, remix, version radio, etc... Texte libre tel qu&apos;on souhaite le voir apparaître dans un lecteur audio.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
        <location filename="tgit/ui/track_edition_page.py" />
...
<context>
    ...
    <message>
        <location filename="tgit/ui/new_project_page.py"/>
...
<context>
    ...
    <message>
        <source>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Digitized music must contain metadata in order to be licensed, searched, tracked and paid for online usage. Whether factual, cultural (tags and folksonomy), contractual-time-sensitive, content based or usage generated, new norms and standards are being defined to acknowledge the increasing role of music metadata.&lt;/p&gt;&lt;p&gt;The TGIT software project is an indexation platform containing music metadata for the use of creators, performers, producers of sound recordings, record labels.&lt;/p&gt;&lt;p&gt;For more information, please visit &lt;a href="http://tagyourmusic.com/"&gt;&lt;span style=" text-decoration: underline; color:#0000ff;"&gt;tagyourmusic.com&lt;/span&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p&gt;This product is licensed under the &lt;a href="https://gnu.org/licenses/gpl.html"&gt;&lt;span style=" text-decoration: underline; color:#0000ff;"&gt;GNU General Public License v3&lt;/span&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p&gt;TGiT is built with &lt;span style=" font-weight:600;"&gt;Python {}&lt;/span&gt;, &lt;span style=" font-weight:600;"&gt;Qt {}&lt;/span&gt;, &lt;span style=" font-weight:600;"&gt;PyQt {}&lt;/span&gt; and &lt;span style=" font-weight:600;"&gt;Mutagen {}&lt;/span&gt;&lt;/p&gt;&lt;p&gt;Copyright (C) 2015 Iconoclaste Musique Inc.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</source>
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Il n’est pas rare que nous comparions la culture de l’ère numérique à l’air que nous respirons, à l’eau qui coule de nos robinets. Chez TGiT nous soutenons que la musique, substantive matière noble, est comme un fromage qui, sous l’effet de la numérisation, se liquéfie! Les métadonnées sont comme le pain d’un sandwich au fromage fondu, la fibre qui permet de contenir cette liquéfaction, qui permet une consommation optimale et durable de la musique numérisée. Si nous privons la musique numérique des informations qui la décrivent, l’auditeur ne sait pas ce qu’il écoute et les créateurs ne sont pas payés pour leur travail. Si nous privons le « grilled-cheese » du pain, ce n’est plus un sandwich au fromage fondu, c’est un dégât.&lt;/p&gt;&lt;p&gt;Pour plus d'informations, s'il vous plaît visiter &lt;a href="http://tagyourmusic.com/fr"&gt;&lt;span style=" text-decoration: underline; color:#0000ff;"&gt;tagyourmusic.com&lt;/span&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p&gt;Ce produit est distribué sous la &lt;a href="https://gnu.org/licenses/gpl.html"&gt;&lt;span style=" text-decoration: underline; color:#0000ff;"&gt;GNU General Public License v3&lt;/span&gt;&lt;/a&gt;.&lt;/p&gt;&lt;p&gt;TGIT est construit avec &lt;span style=" font-weight:600;"&gt;Python {}&lt;/span&gt;, &lt;span style=" font-weight:600;"&gt;Qt {}&lt;/span&gt;, &lt;span style=" font-weight:600;"&gt;PyQt {}&lt;/span&gt; and &lt;span style=" font-weight:600;"&gt;Mutagen {}&lt;/span&gt;&lt;/p&gt;&lt;p&gt;Copyright (C) 2015 Iconoclaste Musique Inc.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
</context>
<context>
