...
from PyQt5.QtWidgets import QLabel, QFormLayout, QLineEdit, QSizePolicy, QComboBox, QTimeEdit, QPushButton, QCheckBox, \
    QHBoxLayout, QVBoxLayout

from tgit.ui.helpers.text_area import TextArea
