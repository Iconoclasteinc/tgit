...
class TrackEditionPage(QWidget, UIFile, AlbumListener):
    ...
    def _setup_ui(self):
        ...
        self._artistic_producer.editingFinished.connect(emit_metadata_changed)
        self._initial_producer.editingFinished.connect(emit_metadata_changed)
        self._initial_producer_region.activated.connect(emit_metadata_changed)
    ...
    def display_track(self, track):
        ...
        self._artistic_producer.setText(track.artistic_producer)
        self._initial_producer.setText(track.initial_producer)
        self._display_region(track.initial_producer_region, self._initial_producer_region)
