...
class Tagger:
    ...
    def _chain_of_title_tab(track):
        ...
        return ui.make_chain_of_title_tab(chain_of_title, on_contributor_changed=chain_of_title.update_contributor)
